...
register(
    ...
    entry_point='rosbot_env:HusarionWalldodgeEnv',
...
class HusarionWalldodgeEnv(husarion_env.HusarionEnv):
    ...
    def _get_obs(self):
        ...
        observations = discretized_laser_scan + [past_lin] + [past_ang] + [current_distance] + [rel_theta / 360]
        obs = numpy.asarray(observations)
        return obs
