...
model_dir = '/home/marvin/ros_workspace/src/rosbot_openai/ddpg_models/actor/'
...
class ActorNetwork:
	...
	def create_network(self,state_dim, action_dim):
		...
		return state_input, action, [W1,b1,W2,b2,W4,b4,W3,b3], is_training
	...
	def save_network(self,time_step):
		...
		self.saver.save(self.sess, model_dir + 'actor-network-ddpg', global_step=time_step)