...
class HusarionWalldodgeEnv(husarion_env.HusarionEnv):
    def __init__(self):
        ...
        self.desired_position.position.x = -2.0  # rospy.get_param("/husarion/desired_pose/x")
        ...
        self.end_episode_points = 120.0  # rospy.get_param("/husarion/end_episode_points")
    ...
    def _get_obs(self):
        ...
        observations = discretized_laser_scan + [past_lin] + [past_ang] + [current_distance/diagonal_dis] + [rel_theta / 360] + [yaw/360] + [diff_angle/180]
        return observations
