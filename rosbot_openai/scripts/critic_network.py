...
model_dir = '/home/marvin/ros_workspace/src/rosbot_openai/ddpg_models/critic/'
...
class CriticNetwork:
    ...
    def train(self, y_batch, state_batch, action_batch):
        ...
        self.sess.run(self.optimizer,
                      feed_dict={self.y_input: y_batch, self.state_input: state_batch, self.action_input: action_batch})
    ...
    def save_network(self, time_step):
        ...
        self.saver.save(self.sess, model_dir + 'critic-network-ddpg', global_step=time_step)